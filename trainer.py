...
with strategy.scope():
    ...
    unet = unet.Unet(dim=160, num_res_blocks=1, dropout=0.0, dim_mults=[1, 2, 3, 4], attention_resolutions=(2, 4, 8), num_classes=dataset.num_classes, learned_variance=True)
